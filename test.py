...
class TransitTests(unittest.TestCase):
    def test_map_requests_location_with_center_fallback(self):
        ...
        self.assertIn("bus-tracker-map-view", location_code)
        self.assertIn("localStorage.setItem(viewStorageKey", location_code)
        self.assertIn("!userMovedMap && !localStorage.getItem(viewStorageKey)", location_code)
